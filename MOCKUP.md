...
const BetMateEndGame = () => {
  const [gameState, setGameState] = useState('live'); // 'live', 'ending', 'ended'
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ position: 'relative' }}>
          ...
          <div style={{ position: 'relative' }}>
            {/* The board - simplified representation */}
            <div style={{
              aspectRatio: '1',
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                <div key={i} style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    <div style={{
                      ...
                      height: '8px',
                      borderRadius: '50%',
                      background: bet.type === 'black_win' ? '#1a1a24' : bet.type === 'white_win' ? '#e8e8e8' : '#6366f1',
                      border: bet.type === 'black_win' ? '1px solid #444' : 'none',
          ...
          {/* Summary Card - appears after game ends */}
          {showSummary && (
            <div style={{
