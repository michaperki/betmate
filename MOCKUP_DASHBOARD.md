                  ...
                  <div style={{
                    ...
                    <div style={{ display: 'flex', gap: '20px' }}>
                      <div style={{ fontSize: '12px' }}>
                        ...
                        <span style={{ color: '#22c55e', fontWeight: '600' }}>${match.totalPool.toFixed(2)}</span>
                      </div>
                      <div style={{ fontSize: '12px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                {recentBets.map((bet, i) => (
                  <div key={i} style={{
                    ...
                    alignItems: 'center',
                    padding: '12px 14px',
                    background: bet.result === 'won' ? 'rgba(34, 197, 94, 0.06)' : 'rgba(239, 68, 68, 0.04)',
                    borderRadius: '10px',
                    border: `1px solid ${bet.result === 'won' ? 'rgba(34, 197, 94, 0.15)' : 'rgba(239, 68, 68, 0.1)'}`
                  }}>
                    <div>
                      <div style={{ fontSize: '13px', fontWeight: '500', marginBottom: '2px' }}>{bet.type}</div>
                      <div style={{ fontSize: '11px', opacity: 0.5 }}>@ {bet.odds}x • ${bet.amount.toFixed(2)}</div>
                    </div>
                    <div style={{
                      fontSize: '13px',
                      fontWeight: '600',
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                {leaderboard.map((user, i) => (
                  <div key={i} style={{
                    ...
                    gap: '12px',
                    padding: '12px 14px',
                    background: user.isYou ? 'rgba(34, 197, 94, 0.08)' : 'transparent',
                    borderRadius: '10px',
                    border: user.isYou ? '1px solid rgba(34, 197, 94, 0.2)' : '1px solid transparent'
                  }}>
                    <div style={{
                      width: '24px',
                      fontSize: '14px',
            ...
            <div style={{
              ...
              <div>
                ...
                <div style={{ fontSize: '18px', fontWeight: '700' }}>$1,247.80</div>
              </div>
              <div>
                <div style={{ fontSize: '11px', opacity: 0.5, marginBottom: '4px' }}>Avg Bet Size</div>
                <div style={{ fontSize: '18px', fontWeight: '700' }}>$14.34</div>
              </div>
              <div>
                <div style={{ fontSize: '11px', opacity: 0.5, marginBottom: '4px' }}>Best Win</div>
                <div style={{ fontSize: '18px', fontWeight: '700', color: '#22c55e' }}>+$87.50</div>
              </div>
              <div>
